...
Description     : This module provides a method to perform mass budget
                  ...
                  The divergence/inverse Laplacian and gradients are calculated
                  either on spectral domain with spherical harmonics or
                  on fixed grid using finite difference.
