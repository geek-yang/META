...
Description     : This module provides a method to perform mass budget
                  ...
                  to the error in barotropic winds. 
...
class correction:
    def __init__(self, q, sp, u, v, q_last, q_next, sp_last, sp_next, A, B,
        ...
        param t: time dimension of input files
        param h: level dimension of input files
        param y: latitude dimension of input files
        param x: longitude dimension of input files
        param lat: latitude
