        ...
        for i in year:
            ...
            for j in month:
                ...
                for k in days:
                    ...
                    tt, hh, yy, xx = q.shape
                    AMET = meta.amet.met()
                    E_day[k-1,:,:], cpT_day[k-1,:,:], Lvq_day[k-1,:,:], gz_day[k-1,:,:],\
                    uv2_day[k-1,:,:], E_c_day[k-1,:,:], cpT_c_day[k-1,:,:], Lvq_c_day[k-1,:,:],\
                    gz_c_day[k-1,:,:], uv2_c_day[k-1,:,:] = AMET.calc_met(T, q, sp, u, v, z_model,
